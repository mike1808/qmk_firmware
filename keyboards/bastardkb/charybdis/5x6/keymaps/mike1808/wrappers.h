...
#define _________________RAISE_L2__________________       _______, _______, _______, KC_LBRC, KC_RBRC
#define _________________RAISE_L3__________________       _______, _______, _______, KC_LCBR, KC_RCBR
